...
/**
 * Originally created by Luke Klinker for Blur API
 * Minor Modifications made by Ryan Gocal for Sapphyx API
 */

public abstract class BaseLauncherPage extends Fragment {

    public static final String POSITION = "position";
    public static final String DRAWER_OPENED = "com.gsd.launcher.sapphyx.FRAGMENTS_OPENED";
    public static final String DRAWER_CLOSED = "com.gsd.launcher.sapphyx.FRAGMENTS_CLOSED";
